...
pub fn transform_input(
    ...
    let build = BuildParams {
        ...
        fixed_cards: input.fixed_cards.clone().unwrap_or_default(),
        fixed_characters: input.fixed_characters.clone().unwrap_or_default(),
        excluded_cards: input.excluded_cards.clone().unwrap_or_default(),
        challenge_live_character_id: input.challenge_live_character_id,
        multi_teammate_score_up: input.multi_live_teammate_score_up,
        multi_teammate_power: input.multi_live_teammate_power,
        unit_filter: input.unit_filter.clone(),
        attr_filter: input.attr_filter.clone(),
